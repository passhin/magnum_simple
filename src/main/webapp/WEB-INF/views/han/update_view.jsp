...
<div class="update" style="margin-top:10%">
	...
	<form id="updateForm2">
		<fieldset>
			<legend class="myhidden">update</legend>
			<div class="form-group">
				<div class="form-group">
				...
				<div>
					...
					<input type="text" name="fname" id="fname" class="form-control" value="${dto.fname }">
				</div>
				<div>
				...
				<div>
					...
					<input type="number" name="cost" id="cost" class="form-control" value="${dto.cost }">
				</div>
				...
				<div class="text-right" style="margin: 5% 5% 0 0">
					...
					<a href="javascript:history.go(-1)" class="btn btn-default">취소하기</a>
