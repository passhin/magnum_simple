...
<script>
	...
	<div class="btn-a" style="text-align: right; margin-top: 10px; width:80%">
		<input type="button" value="데이트코스 삭제"	onclick="deleteView()" class="btn btn-success">
		<input type="button" value="데이트코스 완료"	onclick="completeView()" class="btn btn-success">
	</div>
</body>
